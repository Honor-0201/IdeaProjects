...
//        dsc.setUrl("jdbc:mysql://192.168.0.224:7788/yunjing_hdfxyh?useUnicode=true&characterEncoding=utf8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8");
        dsc.setUrl("jdbc:mysql://192.168.0.117:3306/yunjing_keysearch?useUnicode=true&characterEncoding=utf8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
//        dsc.setPassword("Xa_20W-km@0205!2569");
        ...
        pc.setParent("com.lxk.autogenerate");   //自定义包的路径
        ...
        strategy.setInclude("redlist");    //设置映射的表名，可以设置多个表
